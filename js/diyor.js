...
function my(x){
    ...
    for(var j=x*9-9;j<x*9;j++){
        ...
        <div class="card">
        <div class="item-1">
            <a href="#"><img src="${A[j].img}" alt="Image2" class="img-fluid img-fluid class="d-bloc" alt="..."></a>
            <div class="item-1-contents">
              ...
              <div class="rent-price"><span>${A[j].sena}</span>day</div>
              </div>
              <ul class="specs">
                <li>
                  <span>Расход:</span>
              ...
              <div class="d-flex action">
                <a href="contact.html" class="btn btn-primary">арендовать</a>
              </div>
            </div>
          </div>
      </div>
